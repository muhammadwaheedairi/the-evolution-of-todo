...
class TaskBase(SQLModel):
    ...
    recurrence_pattern: Optional[str] = Field(default=None, max_length=50, sa_column_kwargs={"name": "recurrence_pattern"})
    next_occurrence_date: Optional[datetime] = Field(default=None, sa_column_kwargs={"name": "next_occurrence_date"})
    
    # Phase 5 - Intermediate Features
    priority: str = Field(default="medium", max_length=20, sa_column_kwargs={"name": "priority"})
    tags: Optional[str] = Field(default=None, sa_column_kwargs={"name": "tags"})  # JSON array as string
