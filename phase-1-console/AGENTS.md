...
---
## MCP Integration & Claude Shim
1. Initialize Spec-KitPlus: `uv specifyplus init <project_name>`
2. Set up MCP Server with prompts from `.claude/commands`
3. Add Anthropic MCP Builder Skill
4. Test MCP Server and connect to Claude Code
5. Create CLAUDE.md in root:
```markdown
@AGENTS.md
````

This ensures Claude Code automatically loads the agent instructions.
6. Day-to-Day Workflow:

* Context loading → Claude reads CLAUDE.md → AGENTS.md
* Spec Generation → Task Breakdown → Implementation

7. Constitution vs AGENTS.md:

* AGENTS.md = How (workflow + agent instructions)
* speckit.constitution = What (standards + rules)
